...
// Front-page nav control. The front page itself stays public (see
// page.tsx / middleware.ts) — this just lets the presenter sign in from
// the landing page instead of hitting the redirect-to-signin wall at
// /session. Server Actions are the Auth.js v5 App Router pattern for
// sign in/out without a client component.
